...
?>
        ...
        <head>
            ...
            <title>Reciclar herramientas</title>
        ...
        <body class="hold-transition sidebar-closed sidebar-collapse">
                                ...
                                <div class="card card-info">
                                    <div class="card-header">
                                        <div class="row justify-content-center">
                                            <h3 style="color: black;">Herramientas</h3>
                                        </div>
                                        <div class="row justify-content-center">
                                            <input type="image" src="imagenes/tools.png" width="56px">
                                        </div>

                                    </div>
                                    <div class="card-body p-0">

                                        <table id="tablaRHerramientas" class="display table-bordered" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>NOMBRE</th>
                                                    <th>DESCRIPCIÓN</th>
            ...
            <!----------Modals--------------->
            <?php
            include "Modal/RecuperarHerramienta.php";
            ?>
