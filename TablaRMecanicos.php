...
?>
        ...
        <head>
            ...
            <title>Mecánicos dados de baja</title>
                                ...
                                <div class="card card-info">
                                    <div class="card-header">
                                        <div class="row justify-content-center">
                                            <h3 style="color: black;">Mecánicos dados de baja</h3>
                                        </div>
                                        <div class="row justify-content-center">
                                            <input type="image" src="imagenes/mecanico.png" width="56px">
                                        </div>

                                    </div>
                                    <div class="card-body p-0">
                                        <table id="tablaRMecanicos" class="display table-bordered" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>NOMBRE</th>
                                                    <th>AREA</th>
