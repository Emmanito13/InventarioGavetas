...
?>
        ...
        <body class="hold-transition sidebar-closed sidebar-collapse">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-info">
                                    <div class="card-header">
                                        <h3 class="card-title" style="color: black;">Usuarios</h3>
                                        <div class="card-tools">
                                            <ul class="nav nav-pills ml-auto">
                                                <li class="nav-item">
                                                    <a data-toggle="modal" data-target="#nuevo_usuario" class="btn btn-success"> <i class="fas fa-user-plus"> </i> </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <table id="tablaUsuarios" class="display table-bordered" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>NOMBRE</th>
                                                    <th>EMAIL</th>
            ...
            include 'Modal/Epass.php';
            include 'Modal/CaptchaEliminaUsuario.php';
            ?>
